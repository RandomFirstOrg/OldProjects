const arr =  [
    ...
    // function mydata(value,index,array)
    // {
    //     console.log(value)
    //     return value.age<25;
    // }

//     const filteredarr = arr.filter((arr) => arr.age <25);
// // console.log(filteredarr);
// filteredarr.forEach(({age})=>{
//     const shortAge =  age;})
// // result = shortAge;
// console.log(age);


const newArray = arr.filter((arr) => arr.age <= 25);
console.log(newArray)

let temp = [];

newArray.forEach(({ age }) => {
    const shortAge = age;
